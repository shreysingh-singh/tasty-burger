...
import PromotingImage from "../../assets/promotion/pro.png"
        ...
        <Container>
          <Row className="align-items-center">
            <Col lg={6} className="text-center mb-5 mb-lg-0">
              <img src={PromotingImage} className="img-fluid" alt="Promoting" />
            </Col>
            <Col lg={6} className="px-5">
              ...
              <ul>
                ...
                <li>
                  <p>
                    pemo ipsam egestas volute turpis dolores ut aliquam quaerat
